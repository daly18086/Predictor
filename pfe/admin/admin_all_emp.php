...
$result = mysqli_query($conn, "SELECT * FROM account_details  ORDER BY hiredate");
      ...
      <body>
        ...
        <div class="container">
          <div class="table-wrapper">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h2 style="color:orange;">Manage <b style="color:orange">All Engineers</b>
                </h2>
              </div>
            ...
            <tbody>
              <tr>
                ...
                ?>
                  ...
                  <td><?php if ($row["role"] == 'a') echo 'Administrator';
                      else if ($row["role"] == 'c') echo 'Chef Engineer';
                      else echo 'Engineer' ?></td>
                  <td>
                    ...
                    <form action="admin_all_delete.php" method="POST">
                      <input type="hidden" name="mat" value="<?php echo $row['matricule']; ?>">
            ...
            <div id="addEmployeeModal" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form action="add_all_to_db.php" method="POST">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label>Role</label>
                        <input placeholder="a:admin ; c:chef ; e:engineer" maxlength="1" type="text" name="role" class="form-control" required>
                      </div>
                    </div>
