                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Phone Number" value="<?php echo $row['phone']; ?>" type="text" name="phone" maxlength="8" pattern="[0-9]{8}" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
