...
$result = mysqli_query($conn, "SELECT * FROM account_details  WHERE role = 'c' ORDER BY hiredate");
      ...
      <body>
        ...
        <div class="container">
          <div class="table-wrapper">
            <div style="position:absolute; left:1040px; top:170px;">
              <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add A Chef Engineer</span></a>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <h2 style="color:orange;">Manage <b style="color:orange">Chef Engineers</b>
                </h2>
              </div>

            </div>

            <form action="delete_multiple_chef.php" method="POST">
                ...
                ?>
                  ...
                  <td>
                    <span class="custom-checkbox">
                      <input type="checkbox" id="checkbox1" name="matricule_cb[]" value="<?= $row['matricule']; ?>">
                  ...
                  <td><?php if ($role == "c") echo $row["name"]; ?></td>
                  <td><?php if ($role == "c") echo $row["email"]; ?></td>
                  <td><?php if ($role == "c") echo $row["phone"]; ?></td>
                  <td><?php if ($role == "c") echo $row["department"]; ?></td>
                  <td><?php if ($role == "c") echo $row["hiredate"]; ?></td>
                  <td>
                    ...
                    <form action="admin_chef_delete.php" method="POST">
                      <input type="hidden" name="mat" value="<?php echo $row['matricule']; ?>">
            ...
            <div id="addEmployeeModal" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form action="add_chef_to_db.php" method="POST">
                    <div class="modal-header">
                      <h4 class="modal-title" style="color:orange">Add Chef Engineer</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                      <div class="form-group">
                        <label>Id</label>
                        <input placeholder="Identifier" type="text" name="id" maxlength="8" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Password</label>
                        <input placeholder="Password" type="text" name="password" class="form-control" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input placeholder="Department" type="text" name="department" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Phone Number</label>
                        <input placeholder="Phone Number" maxlength="8" type="text" name="phone" pattern="[0-9]{8}" class="form-control" required>
                      </div>
                      <div class="form-group">
                        <label>Email</label>
                      ...
                      <div class="form-group">
                        ...
                        <input placeholder="Engineer's Hiring Date" type="date" name="hiredate" id="date" class="form-control" required>
                      </div>
                    </div>
                    <div class="modal-footer">
                      <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                      <button type="submit" name="submit" class="btn btn-success">Add Chef Engineer</button>
                    </div>
                  </form>
                </div>
              </div>
