                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Chef Engineer's Hiring Date" value="<?php echo $row['hiredate']; ?>" type="date" name="hiredate" id="date" class="form-control" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <a href="admin_chef.php" class="btn btn-danger"> CANCEL </a>
