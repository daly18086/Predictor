...
$result = mysqli_query($conn, "SELECT * FROM year_states");
          ...
          <div class="table-wrapper">
            <div class="row">
              <div class="col-sm-6">
                ...
                <h2 style="color:orange">Consult <b style="color:orange">Year's Yields</b></h2>
              </div>
              ...
              <tbody>
                <tr>
                  ...
                  ?>
                    ...
                    <td>
                      <?php
                      if ($row["T1"] == "INCREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-success btn-xs">' . $row["T1"] . '</button>';
                      else if ($row["T1"] == "DECREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-danger btn-xs">' . $row["T1"] . '</button>';
                      else
                        echo '<button type="submit" name="delete_cb" class="btn btn-outline-warning btn-xs">' . $row["T1"] . '</button>';
                      ?>
                    </td>
                    <td>
                      <?php
                      if ($row["T2"] == "INCREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-success btn-xs">' . $row["T2"] . '</button>';
                      else if ($row["T2"] == "DECREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-danger btn-xs">' . $row["T2"] . '</button>';
                      else
                        echo '<button type="submit" name="delete_cb" class="btn btn-outline-warning btn-xs">' . $row["T2"] . '</button>';
                      ?>
                    </td>
                    <td>
                      <?php
                      if ($row["T3"] == "INCREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-success btn-xs">' . $row["T3"] . '</button>';
                      else if ($row["T3"] == "DECREASING") echo '<button type="submit" name="delete_cb" class="btn btn-outline-danger btn-xs">' . $row["T3"] . '</button>';
                      else
                        echo '<button type="submit" name="delete_cb" class="btn btn-outline-warning btn-xs">' . $row["T3"] . '</button>';
                      ?>
                    </td>
                    <td>
                      <?php
