        ...
        <div class="container">
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                <div class="col-sm-6">
                  <h2 style="color:orange">Engineer <b style="color:orange">End of day report</b></h2>
                ...
                ?>
                  ...
                  <td>
                    <form action="submit_report.php" method="POST">
                      <span class="valuePadding"><input name="progress" type="number" max="100" maxlength="3" accuracy="2" min="0" id="inputRRPDiscount" style="text-align:left;">%</span>
                      <input type="hidden" name="mat" value="<?php echo $row['id']; ?>">
                      <input type="hidden" name="name" value="<?php echo $row['name']; ?>">
                      <input type="submit" name="submit_bouton" class="btn btn-info btn-xs" value="REPORT">
                    </form>
                  </td>
              </tr>
            <?php
