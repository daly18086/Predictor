                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Phone Number" value="<?php echo $row['phone']; ?>" maxlength="8" type="text" name="phone" pattern="[0-9]{8}" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                        ...
                        <div class="modal-footer">
                            <a href="chef_emp.php" class="btn btn-danger"> CANCEL </a>
