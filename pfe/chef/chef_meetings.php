  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5">
        ...
        <strong style="text-align:center;color:orange"> WELCOME <?php echo $_SESSION['username'] ?> </strong>
            ...
            <tbody>
              <tr>
                ...
                ?>
                  ...
                  <td>
                    <form action="chef_edit_meetings.php" method="POST">
                    ...
                    <form action="chef_delete_meeting.php" method="POST">
                      <input type="hidden" name="id_meeting" value="<?php echo $row['id']; ?>">
