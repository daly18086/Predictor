...
$result = mysqli_query($conn, "SELECT * FROM psy");
          ...
          <div class="table-wrapper">
            <div class="row">
              <div class="col-sm-6">
                ...
                <h2 style="color:orange">Manage <b style="color:orange">Psychologists</b>
                </h2>
              </div>

            </div>

            <form action="chef_delete_multiple_psy.php" method="POST">
            ...
            <tbody>
              <tr>
                ...
                ?>
                  ...
                  <td>
                    <form action="chef_edit_psy.php" method="POST">
                    ...
                    <form action="chef_delete_psy.php" method="POST">
                ...
                <div class="modal-content">
                  <form action="add_psy_to_db.php" method="POST">
                    ...
                    <div class="modal-footer">
                      <a href="chef_psy.php" class="btn btn-danger"> CANCEL </a>
                      <button type="submit" name="editbtn" class="btn btn-success">Add Psychologist</button>
                    </div>
                  </form>
                </div>
              </div>
